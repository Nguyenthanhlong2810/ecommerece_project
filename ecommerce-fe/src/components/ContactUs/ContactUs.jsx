...
const ContactUs = () => {
  ...
  const handleSubmit = (e) => {
    ...
    confirm({
      title: "Bạn có muốn gửi biểu mẫu",
      onConfirm: () => {
        console.log("confirm");
      },
      cancelText: "Huỷ",
  ...
  return (
    <div className=" md:min-w-[1280px] sm:mx-10 sm:text-sm">
      <div className=" mt-20 bg-white md:mx-80 border rounded-3xl ">
          ...
          <div className="px-5 py-2 mx-auto">
            <div className="flex flex-col text-center w-full my-6">
              ...
              <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
                Liên lạc với chúng tôi nếu bạn cần tư vấn
              </p>
            </div>
            <div className="lg:w-1/2 md:w-2/3 mx-auto">
              <div className="flex flex-wrap -m-2">
                <div className="p-2 w-1/2">
                  <div className="">
                    <label className="leading-7 text-sm text-blue">Name</label>
                    <input
                      type="text"
                      id="name"
                      name="name"
                ...
                <div className="p-2 w-1/2">
                  <div className="">
                    <label className="leading-7 text-sm text-blue">Email</label>
                    <input
                      type="email"
                      id="email"
                      name="email"
                ...
                <div className="p-2 w-full">
                  <div className="">
                    <label className="leading-7 text-sm text-blue">
                      Message
                    </label>
                    <textarea
                      id="message"
                ...
                <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                  <a className="text-indigo-500">imlucas2810@email.com</a>
