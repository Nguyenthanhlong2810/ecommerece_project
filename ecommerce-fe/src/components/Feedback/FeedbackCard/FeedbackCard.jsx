...
const FeedbackCard = () => {
  return (
    <div className="flex ">
      <div className=" mx-2 grid grid-cols-1 gap-4 lg:gap-8 sm:gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <div>
          ...
          <div className="relative mb-8 bg-blue rounded-xl shadow dark:bg-gray-700">
            <div className="absolute inline-block overflow-hidden -translate-x-1/2 w-7 -top-4 left-1/2">
              <div className="w-4 h-4 origin-bottom-left transform rotate-45 bg-gray-300 dark:bg-gray-700 drop-shadow"></div>
            </div>
        ...
        <div>
          ...
          <div className="relative mb-8 bg-blue rounded-xl shadow dark:bg-gray-700">
            <div className="absolute inline-block overflow-hidden -translate-x-1/2 w-7 -top-4 left-1/2">
              <div className="w-4 h-4 origin-bottom-left transform rotate-45 bg-blue dark:bg-gray-700 drop-shadow"></div>
            </div>
            <div className="relative z-20 p-8">
              <p className="text-base leading-7 text-white">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Cum
