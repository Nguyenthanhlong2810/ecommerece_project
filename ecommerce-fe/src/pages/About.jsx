...
const About = () => {
  return (
    <CommonLayout>
      <section class="flex items-center bg-transparent xl:h-screen font-poppins dark:bg-gray-800 ">
          ...
          <div class="flex flex-wrap ">
            ...
            <div class="w-full px-6 mb-10 lg:w-1/2 lg:mb-0 ">
              <div class="pl-4 mb-6 border-l-4 border-blue-500 ">
                <span class="text-sm text-white-600 uppercase dark:text-gray-400">
                  Who we are?
                </span>
                <h1 class="mt-2 text-3xl font-black text-white-700 md:text-5xl dark:text-gray-300">
                  About Us
                </h1>
              </div>
              <p class="mb-6 text-base leading-7 text-white-500 dark:text-gray-400">
